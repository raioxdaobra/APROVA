...
function buildPrompt(q: QuestionRow): string {
  ...
  // Mesmo formato do on-demand multimodal: Feedback da Questao + bloco por
  // alternativa com ❌/✅ + Resumo Final. User definiu esse layout como
  // padrao oficial — qualquer mudanca aqui deve sincronizar com o
  // resolucaoPromptMultimodal de src/lib/llm/on-demand.ts.
  return [
    'Você é um professor universitário. Você está vendo a imagem da questão',
    'de vestibular Unifor Medicina acima. Gere uma resolução no FORMATO EXATO',
    `abaixo. Máximo 450 palavras. A resposta correta é a letra ${letter}.`,
    '',
    ...
    '## Feedback da Questão',
    '',
    '[Em 2-4 frases, explique o conceito central que a questão cobra e',
    'a chave pra resolver. Use LaTeX ($...$ inline, $$...$$ display)',
    'pra fórmulas.]',
    '',
    'Uma dica importante:',
    '',
    ...
    '- [Bullet 2]',
    '',
    '### Alternativa A) [transcrição/resumo do que diz a alternativa]',
    '',
    '[**❌ Incorreta** ou **✅ Correta**]',
    '',
    '[1-3 frases explicando o erro conceitual ou de cálculo (ou o',
    'motivo positivo, no caso da correta).]',
    '',
    ...
    '## Resumo Final',
    '',
    '[Em 2-3 frases, recapitule a ideia central.]',
    '',
    ...
    '- Transcreva/resuma o conteúdo REAL de cada alternativa — não invente.',
